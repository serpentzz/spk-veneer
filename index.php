    ...
    <main class="max-w-4xl mx-auto py-20 p-6">
        <section class="flex flex-col md:flex-row justify-center items-center gap-8 mb-12">
            <article class="text-amber-950 text-center md:text-left">
                ...
                <a href="hitung.php" 
                    class="transition flex items-center bg-amber-200 hover:bg-amber-950 hover:text-amber-200 border-2 border-amber-950 text-amber-950 text-2xl font-bold py-2 px-4 mt-3 rounded-full shadow-md w-max mx-auto lg:mx-0">
